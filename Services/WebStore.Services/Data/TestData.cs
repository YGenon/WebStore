...
namespace WebStore.Data
{
    public static class TestData
    {
        ...
        {
            new Domain.Entities.Employee { LastName = "Панарин", FirstName = "Семен", Patronymic = "Иванович", Age = 27 },
            new Domain.Entities.Employee { LastName = "Кудинов", FirstName = "Алексей", Patronymic = "Петрович", Age = 31 },
            new Domain.Entities.Employee { LastName = "Варламов", FirstName = "Тимур", Patronymic = "Алексеевич", Age = 18 },
            new Domain.Entities.Employee { LastName = "Меркулов", FirstName = "Виктор", Patronymic = "Сергеевич", Age = 23 },
        };
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product { Id = 8, Name = "Костюм кролика", Price = 2025, ImageUrl = "product8.jpg", Order = 7, SectionId = 25, BrandId = 1 },            
            new Product { Id = 9, Name = "Красное китайское платье", Price = 2025, ImageUrl = "product9.jpg", Order = 8, SectionId = 25, BrandId = 1 },
            new Product { Id = 10, Name = "Женские джинсы", Price = 2025, ImageUrl = "product10.jpg", Order = 9, SectionId = 25, BrandId = 3 },
            new Product { Id = 11, Name = "Джинсы женские", Price = 2025, ImageUrl = "product11.jpg", Order = 10, SectionId = 25, BrandId = 3 },
            new Product { Id = 12, Name = "Летний костюм", Price = 2025, ImageUrl = "product12.jpg", Order = 11, SectionId = 25, BrandId = 3 },
        };
    }
}
